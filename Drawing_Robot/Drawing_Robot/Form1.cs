...
namespace Drawing_Robot
{
    public partial class Form1 : Form
    {
        ...
        void painting(int loop, string[] data)//Bloklarýn içindeki her bir veri deðeri buradaki deðiþken karþýlðýna atýlýr ve iþlenir.
        {
            ...
            int y1 = 0, b1 = 0, l1 = 0, f1 = 0, r1 = 0, y2 = 0, b2 = 0, l2 = 0, f2 = 0, r2 = 0, y3 = 0, b3 = 0, l3 = 0, f3 = 0, r3 = 0, y4 = 0, b4 = 0, l4 = 0, f4 = 0, r4 = 0, b5 = 0, y5 = 0, l5 = 0, f5 = 0, r5 = 0, size1 = 0, size2 = 0, size3 = 0, size4 = 0, size5 = 0;
            ...
            for (int i = 0; i < loop; i++)//Her bir blok tek tek çýkarýlýr.
            {
                if (i == 0)//eðer eþitlik saðlanýyorsa döngü vardýr.
                {
                    ...
                    Regex regex = new Regex(@"F|R|L|B|\d+|COLOR |PEN|BLUE|GREEN|YELLOW|ORANGE|PURPLE|BLACK|WHITE|PINK|GRAY");//bloðun tokenlara tanýmlanmasý.
                    ...
                    for (int a = 0; a < dizi1.Length; a++)//tokenlarn karýþýlýðýna düþen deðerler deðiþkenlere atýlýr.
                    {
                        ...
                        if (dizi1[a] == "B")
                            b1 = Convert.ToInt32(dizi1[a + 1]);
                        if (dizi1[a] == "Y")
                            y1 = Convert.ToInt32(dizi1[a + 1]);
                ...
                else if (i == 1)
                {
                    dongu2 = true;
                    string data2 = data[1];
                    Regex regex2 = new Regex(@"F|R|B|L|\d+|COLOR |Y|PEN|BLUE|GREEN|YELLOW|ORANGE|PURPLE|BLACK|WHITE|PINK|GRAY");
                    ...
                    for (int a = 0; a < dizi2.Length; a++)
                    {
                        ...
                        if (dizi2[a] == "B")
                            b2 = Convert.ToInt32(dizi2[a + 1]);
                        if (dizi2[a] == "Y")
                            y2 = Convert.ToInt32(dizi2[a + 1]);
                ...
                else if (i == 2)
                {
                    dongu3 = true;
                    string data3 = data[2];
                    Regex regex3 = new Regex(@"F|R|B|L|\d+|COLOR |Y|PEN|BLUE|GREEN|YELLOW|ORANGE|PURPLE|BLACK|WHITE|PINK|GRAY");
                    ...
                    for (int a = 0; a < dizi3.Length; a++)
                    {
                        ...
                        if (dizi3[a] == "B")
                            b3 = Convert.ToInt32(dizi3[a + 1]);
                        if (dizi3[a] == "Y")
                            y3 = Convert.ToInt32(dizi3[a + 1]);
                ...
                else if (i == 3)
                {
                    dongu4 = true;
                    string data4 = data[3];
                    Regex regex4 = new Regex(@"F|R|B|L|\d+|COLOR |Y|PEN|BLUE|GREEN|YELLOW|ORANGE|PURPLE|BLACK|WHITE|PINK|GRAY");
                    ...
                    for (int a = 0; a < dizi4.Length; a++)
                    {
                        ...
                        if (dizi4[a] == "B")
                            b4 = Convert.ToInt32(dizi4[a + 1]);
                        if (dizi4[a] == "Y")
                            y4 = Convert.ToInt32(dizi4[a + 1]);
                ...
                else if (i == 4)
                {
                    dongu5 = true;
                    string data5 = data[4];
                    Regex regex5 = new Regex(@"F|R|B|L|\d+|COLOR |Y|PEN|BLUE|GREEN|YELLOW|ORANGE|PURPLE|BLACK|WHITE|PINK|GRAY");
                    ...
                    for (int a = 0; a < dizi5.Length; a++)
                    {
                        ...
                        if (dizi5[a] == "B")
                            b5 = Convert.ToInt32(dizi5[a + 1]);
                        if (dizi5[a] == "Y")
                            y5 = Convert.ToInt32(dizi5[a + 1]);
            ...
            while (dongu1 == true && l1 > 0)
            {
                ...
                if (f1 > 0)
                    forward(f1);
                if (b1 > 0)
                    backward(b1);//1. bloktaki F tokenýn deðerini gerçeklemektedir.
                if (r1 > 0)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(str);
                Regex regex = new Regex(@"F|R|B|L|\d+|[[]|[]]|COLOR |Y|PEN|BLUE|GREEN|YELLOW|ORANGE|PURPLE|BLACK|WHITE|PINK|GRAY");//Ýstenilen tokenlar regexe tanýmlandý.
        ...
        {
            string[] lines = File.ReadAllLines(@"C:\Users\TALHA\Desktop\ders\2.sýnýf 2. dönem\otamata\Drawing_Robot\Drawing_Robot\dizi.txt", Encoding.UTF8);//txt ten alýnan veriler bir diziye line line eklenir
